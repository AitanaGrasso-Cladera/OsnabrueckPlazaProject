...
if desktop == 1
    EEGdataFolder = '/media/agrassoclade/Aitanas_SSD/Osnabruck_Plaza/Data';
    fixationFolder = '/media/agrassoclade/Aitanas_SSD/Osnabruck_Plaza/fixationFiles';
    saccadeFolder = '/media/agrassoclade/Aitanas_SSD/Osnabruck_Plaza/saccadeFiles';
    ETeventsFolder = '/media/agrassoclade/Aitanas_SSD/Osnabruck_Plaza/pupilLabEvents';
...
elseif laptop == 1
    EEGdataFolder = '/Volumes/Aitanas_SSD/Osnabruck_Plaza/Data';
    fixationFolder = '/Volumes/Aitanas_SSD/Osnabruck_Plaza/fixationFiles';
    saccadeFolder = '/Volumes/Aitanas_SSD/Osnabruck_Plaza/saccadeFiles';
    ETeventsFolder = '/Volumes/Aitanas_SSD/Osnabruck_Plaza/pupilLabEvents';
...
for sub = 1:8%length(participants)
    ...
    if EEGstartMessage < EEGsyncMessage
        startET = eventsPL.timestamp_ns_(EEGstartMessage+1);
        startEEG = eventsPL.name(EEGstartMessage+1);
        ...
        ETtimes = eventsPL.timestamp_ns_(EEGstartMessage+1:EEGendMessage);
    else
    ...
    upperLimitETfix = min(find(fixEvents.startTimestamp_ns_ >= eventsPL.timestamp_ns_(EEGendMessage)));
    ...
    upperLimitETsacc = min(find(saccEvents.startTimestamp_ns_ >= eventsPL.timestamp_ns_(EEGendMessage)));
