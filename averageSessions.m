...
% This data is only used for plotting (Figures 5 and 6, Panel A).
% This script was developed by Aitana Grasso-Cladera and Debora Nolte
%% History
% April 2026 = The scripts is developed to find subjects with more than one
% session and average their values.
